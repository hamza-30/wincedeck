...
function NewProject() {
  ...
  return (
    <div className={`flex-1 flex justify-center px-5.5 overflow-hidden`}>
      <PageTransition>
        <div className={`mt-17 h-fit w-full max-w-132`}>
          <Link
            to={"/dashboard"}
          ...
          >
            ...
            <span className={`text-[0.7rem] mt-px`}>BACK TO PROJECTS</span>
          </Link>
          ...
          <div className={`flex gap-x-2 text-[12px] mt-7 font-semibold`}>
            <button
              className={`w-30 bg-black border border-black text-white rounded-md hover:bg-[#000000d1] transition-all ease-in-out duration-150 flex items-center justify-center`}
            ...
            <Link
              to={"/dashboard"}
              className={`w-fit h-fit bg-white border border-gray-300 px-4 py-2.5 rounded-md hover:bg-gray-100 active:bg-gray-100 transition-all ease-in-out duration-150`}
            >
              Cancel
            </Link>
          </div>
