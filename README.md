...
4. View, filter, and analyze errors on your dashboard
---
...
### Settings
- Rename project
- Delete project with confirmation — also cleans up all associated error logs from Firestore
### Tracker
...
Services (authService.js, firestoreService.js)
        ↓
Custom Hooks (useAuth, useErrors, useProject, useProjects, useProjectStats)
        ↓
...
**Delete Cascade**
Firestore does not cascade delete subcollections. When a project is deleted, deleteProject in useProject manually deletes all documents in the errors/{projectId}/logs subcollection before deleting the project document itself.
